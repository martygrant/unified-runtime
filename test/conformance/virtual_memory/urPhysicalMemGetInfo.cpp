...
TEST_P(urPhysicalMemGetInfoTest, SuccessSize) {
  ...
  ASSERT_GET_INFO(urPhysicalMemGetInfo(physical_mem, property_name,
                                      property_size, &property_value, nullptr), size_t);
...
TEST_P(urPhysicalMemGetInfoTest, SuccessReferenceCount) {
  ...
  ASSERT_GET_INFO(urPhysicalMemGetInfo(physical_mem, property_name,
                                      property_size, &property_value, nullptr), uint32_t);
