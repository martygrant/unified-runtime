...
TEST_P(urVirtualMemGranularityGetInfoTest, SuccessMinimum) {
  ...
  ASSERT_GET_INFO(urVirtualMemGranularityGetInfo(context, device, property_name,
                                                 property_size,
...
TEST_P(urVirtualMemGranularityGetInfoTest, SuccessRecommended) {
  ...
  uint32_t property_value = 0;
  ASSERT_GET_INFO(urVirtualMemGranularityGetInfo(
                      context, device, property_name, property_size,
                      &property_value, nullptr),
                  uint32_t);
