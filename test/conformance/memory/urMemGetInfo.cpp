...
TEST_P(urMemGetInfoTest, SuccessSize) {
  ...
  ASSERT_GET_INFO(urMemGetInfo(buffer, property_name, property_size,
...
TEST_P(urMemGetInfoTest, SuccessReferenceCount) {
  ...
  ASSERT_GET_INFO(urMemGetInfo(buffer, property_name, property_size,
                              &property_value, nullptr), uint32_t);
...
TEST_P(urMemGetInfoImageTest, SuccessSize) {
  ...
  size_t property_value = 0;
  ASSERT_GET_INFO(urMemGetInfo(image, property_name, property_size,
                                  &property_value, nullptr),
                  size_t);
